...
const ApproachSection = () => {
  return (
    <section id="enfoque" className="py-16 md:py-24 bg-blue-700 text-white">
      <div className="max-w-4xl mx-auto px-4 md:px-8 text-center">
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-16">
          <div className="p-6 rounded-xl bg-white/5 hover:bg-white/10 transition-colors">
            <div className="text-4xl font-black mb-2 text-blue-300">01</div>
          ...
          <div className="p-6 rounded-xl bg-white/5 hover:bg-white/10 transition-colors">
            <div className="text-4xl font-black mb-2 text-blue-300">02</div>
          ...
          <div className="p-6 rounded-xl bg-white/5 hover:bg-white/10 transition-colors">
            <div className="text-4xl font-black mb-2 text-blue-300">03</div>
